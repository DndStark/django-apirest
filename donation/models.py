...
class Transport(models.Model):
    ...
    transport_origin = models.ForeignKey(Location, models.DO_NOTHING, db_column='transport_origin', related_name='origin')
    transport_destiny = models.ForeignKey(Location, models.DO_NOTHING, db_column='transport_destiny', related_name='destiny')
    user = models.ForeignKey('User', models.DO_NOTHING)
